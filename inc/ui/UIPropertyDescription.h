...
namespace ui {
    ...
    struct PropertyField {
        ...
        // Updated: explicitly specify the variant type template arguments.
        std::function<void(const std::variant<float, std::string>&)> fieldSetter;
    };
    ...
    public:
        ...
        void addField(const std::string& label, FieldType type, const std::variant<float, std::string>& value,
            std::function<void(const std::variant<float, std::string>&)> setter = {});  // default empty
        void addSubProperty(const UIPropertyDescription& subProperty);

        std::function<void(const std::vector<std::variant<float, std::string>>&)>
            getSetter() const { return setter_; }
        void setSetter(std::function<void(const std::vector<std::variant<float, std::string>>)> setter) { setter_ = setter; }
    ...
    private:
        ...
        std::function<void(const std::vector<std::variant<float, std::string>>)> setter_;
